    ...
    <div class="auth-page-container">
      <div class="auth-card">
        ...
        <header class="auth-header">
          ...
          <p class="subtitle">Join our community gathering circle</p>
        </header>

        <!-- Tab Switcher -->
        <div class="tab-switcher">
          <a routerLink="/login" class="tab-btn inactive">Sign In</a>
        ...
        <form (ngSubmit)="onSubmit()" #registerForm="ngForm">
          ...
          <button type="submit" [disabled]="registerForm.invalid || isLoading" class="btn-submit">
            <span *ngIf="!isLoading">
              Create Account <i class="fa-solid fa-arrow-right arrow-icon"></i>
            </span>
